...
const std::vector<WindowControlDefinition>& WindowControlDefinitions::All()
{
    static const std::vector<WindowControlDefinition> definitions = {
        ...
        {kIdStitchModeLabel, L"STATIC", L"Mode", kStaticStyle},
        {kIdStitchModeCombo, L"COMBOBOX", nullptr, kComboStyle},
        {kIdStitchSourceLabel, L"STATIC", L"Image source", kStaticStyle},
        {kIdSelectStitchDirectory, L"BUTTON", L"Select Dir", kButtonStyle},
        {kIdSelectStitchFiles, L"BUTTON", L"Select Files", kButtonStyle},
        ...
        {kIdStitchSearchLabel, L"STATIC", L"Estimated overlap", kStaticStyle},
        ...
        {kIdBuildStitch, L"BUTTON", L"Start Stitch", kButtonStyle},
