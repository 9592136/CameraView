...
CameraPreviewApp::CameraPreviewApp(HWND hwnd) : hwnd_(hwnd)
{
...
CameraPreviewApp::~CameraPreviewApp()
{
...
bool CameraPreviewApp::RefreshCameraList(HWND combo)
{
        Stop();
        ClearLatestFrame();
...
void CameraPreviewApp::UpdateSelectedCamera(HWND combo)
{
...
void CameraPreviewApp::ApplyExposure(HWND edit)
{
...
void CameraPreviewApp::ApplyAutoExposure()
{
...
void CameraPreviewApp::ApplyGain(HWND edit)
{
        double gain = 0.0;
...
void CameraPreviewApp::ApplyWhiteBalance()
{
        if (!camera_driver_.IsOpen()) {
...
void CameraPreviewApp::UpdatePseudoColor(HWND combo)
{
...
void CameraPreviewApp::UpdateHistogramChannel(HWND combo)
{
...
void CameraPreviewApp::UpdateAdjustValueLabels(HWND hwnd)
{
        WCHAR buf[32];
...
void CameraPreviewApp::ResetImageAdjust(HWND hwnd)
{
...
void CameraPreviewApp::OnHistogramSlider(HWND hwnd, LPARAM lp)
{
...
void CameraPreviewApp::ConstrainWindowWidth(HWND hwnd)
{
...
void CameraPreviewApp::SyncPanelCardButtons() const
{
        const int card_ids[] = {
            kIdCameraPanelCard,
            kIdImagePanelCard,
...
void CameraPreviewApp::ShowPanelCategory(int panel_category)
{
...
int CameraPreviewApp::PanelCategory() const
{
        return panel_category_;
}

bool CameraPreviewApp::FunctionPanelVisible() const
{
        return function_panel_visible_;
}

bool CameraPreviewApp::FunctionPanelDockedLeft() const
{
        return function_panel_docked_left_;
}

int CameraPreviewApp::FunctionPanelWidth() const
{
        return function_panel_width_;
}

UILanguage CameraPreviewApp::CurrentLanguage() const
{ return current_language_; }
    UILanguage CurrentLanguage() const { return current_language_; 
}

void CameraPreviewApp::SyncFunctionPanelChrome() const
{
...
void CameraPreviewApp::SetFunctionPanelVisible(bool visible)
{
...
void CameraPreviewApp::ToggleFunctionPanel()
{
        SetFunctionPanelVisible(!function_panel_visible_);
}

void CameraPreviewApp::ReloadUILanguage(UILanguage new_lang)
{
...
INT_PTR CALLBACK CameraPreviewApp::AboutDialogProc(HWND dlg, UINT msg, WPARAM wp, LPARAM lp)
{
...
std::vector<unsigned char> CameraPreviewApp::BuildAboutDialogTemplate()
{
...
void CameraPreviewApp::ShowAboutDialog()
{
...
void CameraPreviewApp::UpdatePanelControlTexts()
{
...
void CameraPreviewApp::ApplyFunctionPanelDockedLeft(bool dock_left, bool announce)
{
...
void CameraPreviewApp::SetFunctionPanelDockedLeft(bool dock_left)
{
        ApplyFunctionPanelDockedLeft(dock_left, true);
}

void CameraPreviewApp::ToggleFunctionPanelDock()
{
        SetFunctionPanelDockedLeft(!function_panel_docked_left_);
}

RECT CameraPreviewApp::FunctionPanelTitleRect() const
{
...
bool CameraPreviewApp::PointInFunctionPanelTitle(POINT point) const
{
        const RECT title = FunctionPanelTitleRect();
        return title.right > title.left && title.bottom > title.top && PtInRect(&title, point);
}

RECT CameraPreviewApp::FunctionPanelResizeGripRect() const
{
...
bool CameraPreviewApp::PointInFunctionPanelResizeGrip(POINT point) const
{
        const RECT grip = FunctionPanelResizeGripRect();
        return grip.right > grip.left && grip.bottom > grip.top && PtInRect(&grip, point);
}

bool CameraPreviewApp::ShouldShowFunctionPanelDockCursor(POINT point) const
{
...
bool CameraPreviewApp::BeginFunctionPanelResize(POINT point)
{
...
bool CameraPreviewApp::ContinueFunctionPanelResize(POINT point)
{
...
bool CameraPreviewApp::EndFunctionPanelResize()
{
        if (!function_panel_resize_active_) {
            return false;
        }
...
bool CameraPreviewApp::BeginFunctionPanelDockDrag(POINT point)
{
...
bool CameraPreviewApp::ContinueFunctionPanelDockDrag(POINT point)
{
...
bool CameraPreviewApp::EndFunctionPanelDockDrag()
{
        if (!function_panel_drag_active_) {
            return false;
        }
...
int CameraPreviewApp::PanelScrollOffset() const
{
        return panel_scroll_offset_;
}

void CameraPreviewApp::ClampPanelScroll()
{
        RECT client = {};
        GetClientRect(hwnd_, &client);
        if (!function_panel_visible_) {
...
void CameraPreviewApp::SyncPanelScrollBar()
{
...
bool CameraPreviewApp::DrawPanelCategoryButton(const DRAWITEMSTRUCT& item) const
{
...
bool CameraPreviewApp::IsToolbarButton(int control_id)
{
...
bool CameraPreviewApp::DrawToolbarButton(const DRAWITEMSTRUCT& item)
{
...
void CameraPreviewApp::InitializeObjectiveControls(HWND combo, HWND name_edit)
{
...
void CameraPreviewApp::SelectObjective(HWND combo, HWND name_edit)
{
...
void CameraPreviewApp::AddObjective(HWND combo, HWND name_edit)
{
...
void CameraPreviewApp::RenameSelectedObjective(HWND combo, HWND name_edit)
{
        EnsureObjectiveCalibrationCount();
        const std::wstring objective = TextInputParser::Trim(ReadEditText(name_edit, 128));
        if (objective.empty()) {
...
void CameraPreviewApp::DeleteSelectedObjective(HWND combo, HWND name_edit)
{
        EnsureObjectiveCalibrationCount();
...
void CameraPreviewApp::InitializeDyeCombo(HWND combo)
{
        if (!combo) {
            return;
        }
...
CameraPreviewApp::HWND emission_edit, HWND red_edit, HWND green_edit, HWND blue_edit)
{
...
void CameraPreviewApp::UpdateFusionPreview(HWND checkbox)
{
...
void CameraPreviewApp::AddCurrentFrameAsChannel(HWND dye_combo, HWND channel_list, HWND fusion_checkbox)
{
...
void CameraPreviewApp::ClearFluorescenceChannels(HWND channel_list, HWND fusion_checkbox)
{
        const FluorescenceChannelListActionResult result =
...
void CameraPreviewApp::SyncSelectedChannelControls(HWND list, HWND visible_checkbox, HWND black_edit, HWND white_edit)
{
...
void CameraPreviewApp::ApplySelectedChannelSettings(HWND list, HWND visible_checkbox, HWND black_edit, HWND white_edit)
{
        int black_level = 0;
        int white_level = 255;
...
void CameraPreviewApp::AddCurrentFrameAsStitchTile()
{
...
LiveStitchPreviewOptions CameraPreviewApp::CurrentLiveStitchPreviewOptions() const
{
...
LiveStitchCaptureOptions CameraPreviewApp::CurrentLiveStitchCaptureOptions() const
{
...
void CameraPreviewApp::ClearLiveStitchPreviewTileCache()
{
        live_stitch_preview_tiles_.clear();
        live_stitch_preview_tile_scale_ = 0;
}

void CameraPreviewApp::ClearLiveStitchReferenceTileCache()
{
        live_stitch_reference_tiles_.clear();
}

LiveStitchPreviewTile CameraPreviewApp::BuildSharedTileRef( const StitchTile& tile, std::shared_ptr<const ImageFrame> shared_frame = nullptr)
{
...
std::vector<StitchTile> CameraPreviewApp::BuildStitchTilesFromRefs( const std::vector<LiveStitchPreviewTile>& refs)
{
...
void CameraPreviewApp::AppendLiveStitchReferenceTileCache( const StitchTile& tile, std::shared_ptr<const ImageFrame> shared_frame = nullptr)
{
...
void CameraPreviewApp::RebuildLiveStitchReferenceTileCache()
{
        ClearLiveStitchReferenceTileCache();
...
void CameraPreviewApp::AppendLiveStitchPreviewTileCache( const StitchTile& tile, std::shared_ptr<const ImageFrame> shared_frame = nullptr)
{
...
void CameraPreviewApp::RebuildLiveStitchPreviewTileCache()
{
        ClearLiveStitchPreviewTileCache();
...
std::vector<LiveStitchPreviewTile> CameraPreviewApp::BuildLiveStitchPreviewSnapshot() const
{
...
std::vector<LiveStitchPreviewTile> CameraPreviewApp::BuildLiveStitchReferenceSnapshot()
{
...
void CameraPreviewApp::InvalidateLiveStitchPreviewState()
{
...
void CameraPreviewApp::WaitForLiveStitchPreviewWorker()
{
...
void CameraPreviewApp::RequestLiveStitchPreviewUpdate()
{
        if (stitch_tiles_.empty()) {
            return;
        }
...
void CameraPreviewApp::LiveStitchPreviewThread()
{
        for (;;) {
...
void CameraPreviewApp::ApplyLiveStitchPreviewResult()
{
        ImageFrame image;
...
void CameraPreviewApp::InvalidateLiveStitchCaptureState()
{
...
void CameraPreviewApp::WaitForLiveStitchCaptureWorker()
{
        InvalidateLiveStitchCaptureState();
...
void CameraPreviewApp::RequestLiveStitchCaptureEvaluation( std::shared_ptr<const ImageFrame> frame, LiveStitchCaptureOptions options)
{
...
void CameraPreviewApp::LiveStitchCaptureThread()
{
        for (;;) {
            LiveStitchCaptureRequest request;
            {
...
void CameraPreviewApp::ApplyLiveStitchCaptureResult()
{
        LiveStitchCaptureResult result;
        bool ready = false;
        {
...
void CameraPreviewApp::SyncLiveStitchControls()
{
...
void CameraPreviewApp::StartLiveStitchCapture()
{
        if (live_stitch_active_) {
...
void CameraPreviewApp::StopLiveStitchCapture(bool update_status = true)
{
        if (!live_stitch_active_) {
            return;
        }
...
void CameraPreviewApp::CaptureLiveStitchTick()
{
        if (!live_stitch_active_) {
            return;
        }
...
void CameraPreviewApp::DeleteSelectedStitchTile()
{
...
void CameraPreviewApp::ClearStitchTiles()
{
        StopLiveStitchCapture(false);
...
bool CameraPreviewApp::IsStitchOrbRegistrationEnabled() const
{
        return IsDlgButtonChecked(hwnd_, kIdStitchOrbRegistration) == BST_CHECKED;
}

void CameraPreviewApp::SyncStitchRegistrationControl()
{
...
int CameraPreviewApp::ComboSelection(HWND combo, int fallback)
{
        const LRESULT selection = combo ? SendMessageW(combo, CB_GETCURSEL, 0, 0) : CB_ERR;
        return selection == CB_ERR ? fallback : static_cast<int>(selection);
}

void CameraPreviewApp::SyncStitchOverlapControls()
{
...
void CameraPreviewApp::SyncStitchSourceStatusControl()
{
...
void CameraPreviewApp::SetStitchSourceStatus(std::wstring status)
{
...
void CameraPreviewApp::SetLiveStitchStatus(const std::wstring& message, bool force = false)
{
        const DWORD now = GetTickCount();
        if (!force &&
...
void CameraPreviewApp::SyncStitchSettingsControls()
{
...
void CameraPreviewApp::InitializeStitchControls()
{
...
bool CameraPreviewApp::ReadIntegerRange(HWND edit, int min_value, int max_value, int& value, const std::wstring& message)
{
...
std::optional<StitchProcessingOptions> CameraPreviewApp::ReadStitchProcessingOptions()
{
...
void CameraPreviewApp::UpdateStitchOverlapFromSlider(HWND slider)
{
        if (!slider) {
            return;
        }
...
void CameraPreviewApp::UpdateStitchSettingsFromControls()
{
...
void CameraPreviewApp::UpdateStitchRegistrationMode()
{
        UpdateStitchSettingsFromControls();
}

void CameraPreviewApp::ImportStitchImageFiles(const std::vector<std::wstring>& file_names, const std::wstring& source_label)
{
        if (file_names.empty()) {
...
void CameraPreviewApp::SelectStitchDirectory()
{
...
void CameraPreviewApp::SelectStitchFiles()
{
        std::vector<std::wstring> file_names;
...
void CameraPreviewApp::BuildStitchPreview()
{
        StopLiveStitchCapture(false);
        InvalidateLiveStitchPreviewState();
        InvalidateLiveStitchCaptureState();
...
void CameraPreviewApp::SaveStitchResult()
{
...
void CameraPreviewApp::AddCurrentFrameAsEdfFrame()
{
        const ProcessingQueueActionResult result =
...
void CameraPreviewApp::BuildEdfPreview()
{
        ProcessingBuildActionResult result =
...
void CameraPreviewApp::ShowEdfFocusMap()
{
...
void CameraPreviewApp::ShowEdfCompositeFrame()
{
        const ProcessingPanelActionResult result =
...
void CameraPreviewApp::ClearProcessing()
{
        StopLiveStitchCapture(false);
        InvalidateLiveStitchPreviewState();
        InvalidateLiveStitchCaptureState();
...
void CameraPreviewApp::RetryProcessing()
{
...
bool CameraPreviewApp::IsLiveCameraPreviewOverlayVisible() const
{
...
bool CameraPreviewApp::HasDrawableBgrRows(const ImageFrame& frame)
{
...
int CameraPreviewApp::FastDownsampleScaleFor(const ImageFrame& source, int max_edge)
{
...
ImageFrame CameraPreviewApp::BuildFastDownsampledFrame(const ImageFrame& source, int scale)
{
        if (!HasDrawableBgrRows(source)) {
            return {};
        }
...
ImageFrame CameraPreviewApp::BuildLivePreviewOverlayFrame(const ImageFrame& source)
{
...
RECT CameraPreviewApp::LiveCameraPreviewOverlayRect(const RECT& preview) const
{
...
RECT CameraPreviewApp::FitFrameRect(const RECT& bounds, const ImageFrame& frame)
{
...
void CameraPreviewApp::DrawLiveCameraPreviewOverlay(HDC hdc, const RECT& preview)
{
...
void CameraPreviewApp::Paint(HDC hdc)
{
        RECT client = {};
        GetClientRect(hwnd_, &client);
...
void CameraPreviewApp::PaintToWindow(HDC hdc, const RECT& dirty)
{
        RECT client = {};
        GetClientRect(hwnd_, &client);
...
bool CameraPreviewApp::HandleMouseWheel(POINT screen_point, short wheel_delta)
{
...
bool CameraPreviewApp::ScrollPanel(short wheel_delta)
{
        if (wheel_delta == 0) {
            return false;
        }
...
bool CameraPreviewApp::HandlePanelScrollCommand(WORD scroll_request)
{
        if (!function_panel_visible_) {
            return false;
        }
...
bool CameraPreviewApp::ScrollPanelTo(int target_offset)
{
        if (!function_panel_visible_) {
            return false;
        }
...
bool CameraPreviewApp::BeginPan(POINT point)
{
        const ImageFrame& frame = CurrentPreviewFrame();
...
bool CameraPreviewApp::ContinuePan(POINT point)
{
        const ImageFrame& frame = CurrentPreviewFrame();
...
void CameraPreviewApp::BeginCalibration(HWND length_edit, HWND unit_combo)
{
        double length = 0.0;
...
void CameraPreviewApp::ClearCalibration()
{
...
void CameraPreviewApp::BeginLengthMeasurement()
{
        const MeasurementToolStartActionResult result =
...
void CameraPreviewApp::BeginAngleMeasurement()
{
        const MeasurementToolStartActionResult result =
...
void CameraPreviewApp::BeginRectangleAreaMeasurement()
{
        const MeasurementToolStartActionResult result =
...
void CameraPreviewApp::BeginPolygonAreaMeasurement()
{
        const MeasurementToolStartActionResult result =
...
void CameraPreviewApp::FinishPolygonAreaMeasurement()
{
...
void CameraPreviewApp::ClearMeasurements(HWND list)
{
        measurements_.Clear();
        measurement_interaction_.Clear();
...
void CameraPreviewApp::DeleteSelectedMeasurement(HWND list)
{
        const LRESULT selection = list ? SendMessageW(list, LB_GETCURSEL, 0, 0) : LB_ERR;
...
void CameraPreviewApp::SyncSelectedMeasurementName(HWND list, HWND edit)
{
        if (!edit) {
            return;
        }
...
void CameraPreviewApp::RenameSelectedMeasurement(HWND list, HWND edit)
{
        wchar_t buffer[160] = {};
        if (edit) {
...
bool CameraPreviewApp::BeginMeasurementEdit(POINT point, HWND list)
{
...
bool CameraPreviewApp::ContinueMeasurementEdit(POINT point)
{
...
void CameraPreviewApp::EndMeasurementEdit()
{
        if (!edit_session_.IsActive()) {
            return;
        }
...
void CameraPreviewApp::ExportMeasurementsCsv()
{
...
void CameraPreviewApp::ExportImage()
{
...
void CameraPreviewApp::OpenImage()
{
        std::wstring file_name;
...
bool CameraPreviewApp::OpenImageFile(const std::wstring& file_name, bool dropped)
{
        if (file_name.empty()) {
...
void CameraPreviewApp::OpenDroppedFiles(const std::vector<std::wstring>& file_names)
{
        if (file_names.empty()) {
...
void CameraPreviewApp::SaveDiagnosticsReport()
{
...
void CameraPreviewApp::LoadReportTemplate()
{
        std::wstring file_name;
...
void CameraPreviewApp::ClearReportTemplate()
{
...
void CameraPreviewApp::ShowReportTemplateDesigner()
{
        if (report_template_designer_ && IsWindow(report_template_designer_)) {
        ...
        auto state = std::make_unique<ReportTemplateDesignerState>();
        state->app = this;
...
void CameraPreviewApp::OpenProject()
{
        std::wstring file_name;
...
bool CameraPreviewApp::HandleLeftClick(POINT point)
{
...
MeasurementToolStartResult CameraPreviewApp::CurrentMeasurementToolAvailability(MeasurementToolStartKind kind) const
{
        return MeasurementToolAvailability::ForFrame(CurrentPreviewFrame(), kind);
}

bool CameraPreviewApp::ApplyMeasurementInteractionActionResult(const MeasurementInteractionActionResult& result)
{
        if (!result.handled) {
            return false;
        }
...
void CameraPreviewApp::PublishProcessingResult(ProcessingJobResult result)
{
        processing_state_.Publish(std::move(result));
        PostMessageW(hwnd_, kMsgProcessingFinished, 0, 0);
}

void CameraPreviewApp::WaitForProcessingWorker()
{
...
void CameraPreviewApp::RequestProcessingCancel()
{
        processing_state_.RequestCancel();
}

bool CameraPreviewApp::StartStitchProcessing( std::vector<StitchTile> tiles, StitchProcessingOptions options, bool remember_snapshot)
{
...
bool CameraPreviewApp::StartEdfProcessing(std::vector<ImageFrame> stack, EdfOptions options, bool remember_snapshot)
{
...
void CameraPreviewApp::InvalidatePreviewFrameCache()
{
...
void CameraPreviewApp::HandleFrameReady()
{
        OnFrameReady();
}

void CameraPreviewApp::ApplyProcessingResult()
{
        if (!processing_state_.IsRunning()) {
            WaitForProcessingWorker();
        }
...
std::filesystem::path CameraPreviewApp::ApplicationDirectory()
{
...
std::filesystem::path CameraPreviewApp::ProcessingOutputDirectory(const wchar_t* subdirectory)
{
        return ApplicationDirectory() / L"exports" / subdirectory;
}

std::filesystem::path CameraPreviewApp::NextProcessingOutputPath( const wchar_t* subdirectory, const wchar_t* file_prefix)
{
        SYSTEMTIME now = {};
        GetLocalTime(&now);
...
std::filesystem::path CameraPreviewApp::AbsolutePathOrSelf(const std::filesystem::path& path)
{
...
std::wstring CameraPreviewApp::SaveVisibleProcessingResult( const wchar_t* subdirectory, const wchar_t* file_prefix, const std::wstring& display_mode) const
{
...
std::wstring CameraPreviewApp::ReadEditText(HWND edit, int max_chars)
{
...
std::wstring CameraPreviewApp::ReadWindowText(HWND control)
{
        if (!control) {
            return {};
        }
...
std::filesystem::path CameraPreviewApp::EnsureFileExtension( const std::filesystem::path& path, const std::wstring& extension)
{
...
std::filesystem::path CameraPreviewApp::ReportImagePathFor(const std::filesystem::path& report_path)
{
...
std::wstring CameraPreviewApp::AbsolutePathText(const std::filesystem::path& path)
{
        std::error_code error;
...
void CameraPreviewApp::SetDesignerStatus(HWND status, const std::wstring& text)
{
        if (status) {
...
void CameraPreviewApp::SetCheckbox(HWND checkbox, bool checked)
{
        if (checkbox) {
...
bool CameraPreviewApp::CheckboxChecked(HWND checkbox)
{
        return checkbox && SendMessageW(checkbox, BM_GETCHECK, 0, 0) == BST_CHECKED;
}

void CameraPreviewApp::SyncTemplateDesignerControlAvailability(ReportTemplateDesignerState* state)
{
        if (!state) {
            return;
        }
...
ImageReportTemplateAccent CameraPreviewApp::ReadVisualTemplateAccent(const ReportTemplateDesignerState* state)
{
        if (!state) {
...
void CameraPreviewApp::SetVisualTemplateAccent( ReportTemplateDesignerState* state, ImageReportTemplateAccent accent)
{
        if (!state) {
            return;
        }
...
ImageReportTemplateImageSize CameraPreviewApp::ReadVisualTemplateImageSize( const ReportTemplateDesignerState* state)
{
        if (!state) {
...
void CameraPreviewApp::SetVisualTemplateImageSize( ReportTemplateDesignerState* state, ImageReportTemplateImageSize image_size)
{
        if (!state) {
            return;
        }
...
ImageReportTemplatePageLayout CameraPreviewApp::ReadVisualTemplatePageLayout( const ReportTemplateDesignerState* state)
{
        if (!state) {
...
void CameraPreviewApp::SetVisualTemplatePageLayout( ReportTemplateDesignerState* state, ImageReportTemplatePageLayout page_layout)
{
        if (!state) {
            return;
        }
...
ImageReportTemplatePrintOrientation CameraPreviewApp::ReadVisualTemplatePrintOrientation( const ReportTemplateDesignerState* state)
{
        if (!state) {
...
void CameraPreviewApp::SetVisualTemplatePrintOrientation( ReportTemplateDesignerState* state, ImageReportTemplatePrintOrientation orientation)
{
        if (!state) {
            return;
        }
...
ImageReportTemplateMeasurementPrecision CameraPreviewApp::ReadVisualTemplateMeasurementPrecision( const ReportTemplateDesignerState* state)
{
        if (!state) {
...
void CameraPreviewApp::SetVisualTemplateMeasurementPrecision( ReportTemplateDesignerState* state, ImageReportTemplateMeasurementPrecision precision)
{
        if (!state) {
            return;
        }
...
std::vector<ImageReportTemplateSection> CameraPreviewApp::DefaultVisualTemplateSectionOrder()
{
        return {
...
const wchar_t* CameraPreviewApp::TemplateSectionLabel(ImageReportTemplateSection section)
{
        switch (section) {
...
const wchar_t* CameraPreviewApp::DefaultTemplateSectionHeading(ImageReportTemplateSection section)
{
        switch (section) {
        case ImageReportTemplateSection::CurrentImage:
            return L"Current Image";
...
std::wstring CameraPreviewApp::VisualTemplateSectionHeading( const ImageReportTemplateOptions& options, ImageReportTemplateSection section)
{
...
std::wstring CameraPreviewApp::TemplateSectionHeadingText( const ReportTemplateDesignerState* state, ImageReportTemplateSection section)
{
        const std::wstring* heading = nullptr;
        if (state) {
            switch (section) {
...
void CameraPreviewApp::SetTemplateSectionHeadingText( ReportTemplateDesignerState* state, ImageReportTemplateSection section, const std::wstring& heading)
{
        if (!state) {
            return;
        }
...
std::wstring CameraPreviewApp::TemplateSectionListText( const ReportTemplateDesignerState* state, ImageReportTemplateSection section)
{
...
COLORREF CameraPreviewApp::TemplateAccentColor(ImageReportTemplateAccent accent)
{
        switch (accent) {
...
COLORREF CameraPreviewApp::TemplateAccentSoftColor(ImageReportTemplateAccent accent)
{
        switch (accent) {
        case ImageReportTemplateAccent::Blue:
...
void CameraPreviewApp::RefreshTemplateSectionList( ReportTemplateDesignerState* state, std::size_t selected_index = 0)
{
...
void CameraPreviewApp::MoveSelectedTemplateSection(ReportTemplateDesignerState* state, int delta)
{
...
void CameraPreviewApp::RefreshTemplateSectionHeadingEdit(ReportTemplateDesignerState* state)
{
...
void CameraPreviewApp::SaveSelectedTemplateSectionHeading(ReportTemplateDesignerState* state)
{
...
const TemplatePlaceholderEntry* CameraPreviewApp::TemplatePlaceholderEntries(std::size_t& count)
{
...
bool CameraPreviewApp::IsTemplateTextTarget(const ReportTemplateDesignerState* state, HWND control)
{
        return state &&
            control &&
...
bool CameraPreviewApp::IsTemplateTextTargetId(int control_id)
{
        switch (control_id) {
...
HWND CameraPreviewApp::ResolveTemplateTextTarget(ReportTemplateDesignerState* state)
{
        if (!state) {
            return nullptr;
        }
...
void CameraPreviewApp::InsertTemplatePlaceholder( ReportTemplateDesignerState* state, const std::wstring& token)
{
...
void CameraPreviewApp::ShowTemplatePlaceholderMenu(HWND hwnd, ReportTemplateDesignerState* state)
{
        if (!state) {
            return;
        }
...
ImageReportTemplateOptions CameraPreviewApp::ReadVisualTemplateOptions(const ReportTemplateDesignerState* state)
{
...
void CameraPreviewApp::ApplyVisualTemplateOptions( ReportTemplateDesignerState* state, const ImageReportTemplateOptions& options)
{
        if (!state) {
            return;
        }
...
void CameraPreviewApp::RefreshTemplatePreview(ReportTemplateDesignerState* state)
{
...
std::optional<std::size_t> CameraPreviewApp::SelectedTemplateSectionIndex( const ReportTemplateDesignerState* state)
{
        if (!state || !state->section_list) {
            return std::nullopt;
        }
...
bool CameraPreviewApp::SelectTemplateSectionIndex( ReportTemplateDesignerState* state, std::size_t selected_index)
{
...
bool CameraPreviewApp::SelectTemplateSection( ReportTemplateDesignerState* state, ImageReportTemplateSection section)
{
        if (!state) {
            return false;
        }
...
std::optional<ImageReportTemplateSection> CameraPreviewApp::HitTestTemplatePreviewSection( const ReportTemplateDesignerState* state, POINT point)
{
        if (!state) {
            return std::nullopt;
        }
...
std::wstring CameraPreviewApp::PreviewFrameSizeText(const ImageFrame& frame)
{
        if (!frame.IsValid()) {
...
RECT CameraPreviewApp::FitPreviewImageRect(const RECT& bounds, const ImageFrame& frame)
{
        if (!frame.IsValid()) {
            return bounds;
        }
...
void CameraPreviewApp::DrawPreviewImageThumbnail(HDC hdc, const RECT& bounds, const ImageFrame& frame)
{
...
std::wstring CameraPreviewApp::PreviewMeasurementSummaryText(const CameraPreviewApp* app)
{
        if (!app) {
...
std::wstring CameraPreviewApp::PreviewMeasurementTableText( const CameraPreviewApp* app, const ImageReportTemplateOptions& options)
{
...
std::wstring CameraPreviewApp::PreviewImageDetailsText(const CameraPreviewApp* app)
{
        if (!app) {
...
void CameraPreviewApp::ApplyDesignedReportTemplate(ReportTemplateDesignerState* state)
{
        if (!state) {
            return;
        }
...
void CameraPreviewApp::SaveDesignedReportTemplate(HWND owner, ReportTemplateDesignerState* state)
{
        if (!state) {
            return;
        }
...
void CameraPreviewApp::DrawTemplatePreview(HWND hwnd, ReportTemplateDesignerState* state)
{
        PAINTSTRUCT paint = {};
...
bool CameraPreviewApp::ScrollReportTemplateDesignerLeftTo( HWND hwnd, ReportTemplateDesignerState* state, int target_offset)
{
        if (!state) {
            return false;
        }
...
CameraPreviewApp::HWND hwnd, ReportTemplateDesignerState* state, int content_top, int content_height)
{
        if (!state) {
            return false;
        }
...
void CameraPreviewApp::ScrollReportTemplateDesignerToSectionHeading( HWND hwnd, ReportTemplateDesignerState* state)
{
        if (!state) {
            return;
        }
...
bool CameraPreviewApp::HandleReportTemplateDesignerLeftScroll( HWND hwnd, ReportTemplateDesignerState* state, int scroll_request)
{
        if (!state) {
            return false;
        }
...
void CameraPreviewApp::LayoutReportTemplateDesigner(HWND hwnd, ReportTemplateDesignerState* state)
{
        if (!state) {
            return;
        }
...
void CameraPreviewApp::RegisterReportTemplateDesignerClass()
{
...
CameraPreviewApp::HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam)
{
        switch (message) {
        case WM_CREATE: {
...
bool CameraPreviewApp::ReadPositiveNumber(HWND edit, double& value)
{
        return TextInputParser::TryParsePositiveDouble(ReadEditText(edit, 64), value);
}

bool CameraPreviewApp::ReadByteValue(HWND edit, int& value)
{
        return TextInputParser::TryParseByte(ReadEditText(edit, 32), value);
}

bool CameraPreviewApp::DecodeUtf8(const std::string& bytes, std::wstring& text)
{
        if (bytes.empty()) {
            text.clear();
            return true;
...
bool CameraPreviewApp::DecodeAnsi(const std::string& bytes, std::wstring& text)
{
        if (bytes.empty()) {
            text.clear();
            return true;
...
bool CameraPreviewApp::DecodeUtf16Le(const std::string& bytes, std::wstring& text)
{
...
bool CameraPreviewApp::ReadTextFile( const std::filesystem::path& path, std::wstring& text, std::wstring& error)
{
...
std::vector<CalibrationProfile> CameraPreviewApp::MakeDefaultObjectiveCalibrations()
{
...
std::vector<std::wstring> CameraPreviewApp::MakeDefaultObjectiveLabels()
{
        return CalibrationProfile::ObjectiveMagnificationOptions();
}

MeasurementUnit CameraPreviewApp::SelectedCalibrationUnit(HWND combo)
{
        const LRESULT selection = combo ? SendMessageW(combo, CB_GETCURSEL, 0, 0) : 0;
        return CalibrationProfile::CalibrationUnitAtIndex(static_cast<int>(selection));
}

int CameraPreviewApp::NormalizeObjectiveIndex(int index) const
{
...
void CameraPreviewApp::EnsureObjectiveCalibrationCount()
{
...
std::wstring CameraPreviewApp::ActiveObjectiveLabel() const
{
        if (objective_labels_.empty()) {
            return L"Objective";
        }
...
void CameraPreviewApp::StoreActiveObjectiveCalibration()
{
        EnsureObjectiveCalibrationCount();
        objective_calibrations_[static_cast<std::size_t>(selected_objective_index_)] = calibration_;
}

void CameraPreviewApp::SyncObjectiveComboSelection(HWND combo) const
{
        if (combo) {
...
void CameraPreviewApp::RefreshObjectiveCombo(HWND combo) const
{
        if (!combo) {
            return;
        }
...
void CameraPreviewApp::SyncObjectiveNameEdit(HWND edit) const
{
        if (edit) {
            const std::wstring objective = ActiveObjectiveLabel();
...
bool CameraPreviewApp::ObjectiveLabelExists(const std::wstring& label, int ignored_index = -1) const
{
...
void CameraPreviewApp::SyncCalibrationStatus() const
{
...
void CameraPreviewApp::SyncReportTemplateStatus() const
{
...
void CameraPreviewApp::ApplyCameraDeviceListPresentation( HWND combo, const CameraDeviceListPresentation& presentation)
{
        if (!combo) {
            return;
        }
...
MeasurementUnit CameraPreviewApp::DisplayUnit() const
{
        return MeasurementDisplayActions::DisplayUnit(calibration_);
}

DyeProfile CameraPreviewApp::SelectedDye(HWND combo) const
{
        const LRESULT selection = combo ? SendMessageW(combo, CB_GETCURSEL, 0, 0) : 0;
        return FluorescenceDisplayActions::SelectedDye(dye_library_, static_cast<int>(selection));
}

std::optional<std::size_t> CameraPreviewApp::SelectedDyeIndex(HWND combo) const
{
...
std::optional<std::size_t> CameraPreviewApp::SelectedChannelIndex(HWND list) const
{
        if (!list) {
            return std::nullopt;
        }
...
bool CameraPreviewApp::HasVisibleFusionPreviewChannel() const
{
...
bool CameraPreviewApp::IsSamePreviewCacheSource(const ImageFrame& source) const
{
...
void CameraPreviewApp::RecordPreviewCacheSource(const ImageFrame& source) const
{
...
const ImageFrame& CameraPreviewApp::CurrentPreviewFrame() const
{
...
MeasurementOverlayModel CameraPreviewApp::BuildMeasurementOverlayModel() const
{
...
std::size_t CameraPreviewApp::MeasurementCount() const
{
        return MeasurementDisplayActions::MeasurementCount(measurements_);
}

std::optional<MeasurementReference> CameraPreviewApp::SelectedMeasurement(HWND list) const
{
        if (!list) {
            return std::nullopt;
        }
...
void CameraPreviewApp::SelectMeasurementInList(HWND list, MeasurementReference reference) const
{
        if (!list) {
            return;
        }
...
void CameraPreviewApp::RefreshMeasurementList(HWND list)
{
        if (!list) {
            return;
        }
...
void CameraPreviewApp::RefreshChannelList(HWND list)
{
        if (!list) {
            return;
        }
...
void CameraPreviewApp::RefreshStitchTileList(HWND list)
{
        if (!list) {
            return;
        }
...
void CameraPreviewApp::AppendStitchTileListItem(HWND list)
{
...
void CameraPreviewApp::ClearLatestFrame()
{
        frame_buffer_.Clear();
...
void CameraPreviewApp::OnFrameReady()
{
...
void CameraPreviewApp::CaptureThread()
{
...
std::wstring CameraPreviewApp::FormatStitchTilePositions(const StitchResultMetadata& metadata)
{
...
DiagnosticReportActionInput CameraPreviewApp::BuildDiagnosticsInput()
{
        SYSTEMTIME now = {};
        GetLocalTime(&now);
...
std::wstring CameraPreviewApp::BuildDiagnosticsReport()
{
...
std::wstring CameraPreviewApp::BuildImageReport( const std::wstring& image_file_name, const ImageFrame& report_image)
{
        DiagnosticReportActionInput input = BuildDiagnosticsInput();
...
std::wstring CameraPreviewApp::BuildSdkTelemetry() const
{
        return DiagnosticReportActions::BuildSdkTelemetry(camera_driver_.Diagnostics());
}

void CameraPreviewApp::SetStatus(const std::wstring& text)
{
        {
            std::lock_guard<std::mutex> lock(status_mutex_);
            status_ = text;
...
void CameraPreviewApp::SetPreviewTelemetry(const std::wstring& text)
{
        {
            std::lock_guard<std::mutex> lock(status_mutex_);
...
void CameraPreviewApp::SetLatestFrameSource(const std::wstring& text)
{
        std::lock_guard<std::mutex> lock(status_mutex_);
        latest_frame_source_ = text;
}

void CameraPreviewApp::FillSolidRect(HDC hdc, const RECT& rect, COLORREF color)
{
...
bool CameraPreviewApp::EnsurePaintBuffer(HDC reference_dc, int width, int height)
{
        if (!paint_buffer_dc_) {
...
void CameraPreviewApp::ReleasePaintBuffer()
{
